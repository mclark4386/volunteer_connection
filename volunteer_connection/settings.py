"""
Django settings for volunteer_connection project.
...
SECRET_KEY = 'dcajdwfv=91&)*ieyv$8x7uk7w*-s6elhh+fna!fqsb4-+t@(k'
...
ROOT_URLCONF = 'volunteer_connection.urls'
...
WSGI_APPLICATION = 'volunteer_connection.wsgi.application'
